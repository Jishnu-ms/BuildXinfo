          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                SideNavItem(
                  icon: Icons.grid_view_rounded, // Matches Dashboard icon style
                  title: "Dashboard",
                ...
                SideNavItem(
                  icon:
                      Icons.folder_open_outlined, // Matches Projects icon style
                  title: "My Projects",
                  isSelected: _currentIndex == 1,
                  onTap: () => setState(() => _currentIndex = 1),
                ),
                SideNavItem(
                  icon: Icons.person, // Matches Cost Estimation icon
                  title: "Users",
